...
public class FPTC_1509CompleteObsROAsseAsPaperTranscriptiFromPortal_SIP extends BaseTest {

	@Factory(dataProvider = "Browsers", dataProviderClass = DataProviders.class)
	public FPTC_1509CompleteObsROAsseAsPaperTranscriptiFromPortal_SIP(String browser) {
		super(browser);		
	}

	private String studyName, visitName1, startedTime = "12:30", durationTime = "14:30";
	...
	@Test(description = "FPTC_1509_Verify Complete an 'ObsRO' assessment as 'Paper transcription' from portal", groups = {
			"R1" })
	public void FPTC_1509_verifyCompleteAnObsROAssessmentAsPaperTranscriptionFromPortal()
		...
		subjectDetailPage.verifySubmittedVisitDate(currentDate().toLowerCase());
