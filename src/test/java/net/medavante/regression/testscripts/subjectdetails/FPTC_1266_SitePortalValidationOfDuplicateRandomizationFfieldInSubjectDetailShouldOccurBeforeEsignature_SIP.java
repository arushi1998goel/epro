...
public class FPTC_1266_SitePortalValidationOfDuplicateRandomizationFfieldInSubjectDetailShouldOccurBeforeEsignature_SIP
		extends BaseTest {


	@Factory(dataProvider = "Browsers", dataProviderClass = DataProviders.class)
	public FPTC_1266_SitePortalValidationOfDuplicateRandomizationFfieldInSubjectDetailShouldOccurBeforeEsignature_SIP(
			String browser) {
		super(browser);
	}
	...
	public void testSetUp() throws Exception {
		...
		Subject01 = properties.getProperty("Subject_Randomization01");
		Subject02 = properties.getProperty("Subject_Randomization02");

	}

	/**
	 * =========================================================================
	 * Test Case Id: FP-TC-1266 Test Case Name: Site Portal: Site Portal:
	 * Validation of duplicate 'Randomization#' field in subject detail should
	...
	@Test(description = "FP-TC-1266_Site Portal: Validation of duplicate 'Randomization#' field in subject detail should occur before e-signature.", groups = {
			"" })
	public void FPTC_1266_SitePortalValidationOfDuplicateRandomizationField() {
		...
		subjectDetailPage.verifyRandomizationNumberIsDisplayed(Subject02);
		...
		reportLog("3.1: Update Randomization no in Edit subject modal window");
		subjectDetailPage.inputRandomNumber(Subject01);
