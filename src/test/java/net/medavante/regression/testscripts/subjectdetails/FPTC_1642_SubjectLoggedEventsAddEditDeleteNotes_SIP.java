...
public class FPTC_1642_SubjectLoggedEventsAddEditDeleteNotes_SIP extends BaseTest {
	...
	public FPTC_1642_SubjectLoggedEventsAddEditDeleteNotes_SIP(String browser) {
		super(browser);
	}
	...
	@Test(description = "FPTC_1642_Subject Logged Events - Add/Edit/Delete Notes", groups = {})
	public void FPTC_1642_VerifySubjectLoggedEventsAddEditDeleteNotes() {
		...
		reportLog("2.1:Select Logged Events from Subject categories drop-down list and click All control");
		...
		subjectDetailPage.clickOnEventRow(Constants.Event_FormName);
