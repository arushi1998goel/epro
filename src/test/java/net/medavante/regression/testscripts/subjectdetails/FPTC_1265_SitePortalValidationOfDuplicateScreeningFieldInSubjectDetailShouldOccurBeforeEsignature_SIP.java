...
public class FPTC_1265_SitePortalValidationOfDuplicateScreeningFieldInSubjectDetailShouldOccurBeforeEsignature_SIP
		extends BaseTest {

	@Factory(dataProvider = "Browsers", dataProviderClass = DataProviders.class)
	public FPTC_1265_SitePortalValidationOfDuplicateScreeningFieldInSubjectDetailShouldOccurBeforeEsignature_SIP(
			String browser) {
		super(browser);
	}
	...
	public void testSetUp() throws Exception {
		...
		Subject01 = properties.getProperty("Subject1_2082");
		Subject02 = properties.getProperty("Subject2_2082");

	}

	/**
	 * =========================================================================
	 * Test Case Id: FP-TC-1265 Test Case Name: Site Portal: Validation of
	 * duplicate 'Screening#' field in subject detail should occur before
	 * e-signature.
	 * =========================================================================
	 * 
	 * @throws Exception
	...
	@Test(description = "FP-TC-1265_Site Portal: Validation of duplicate 'Screening#' field in subject detail should occur before e-signature.", groups = {
			"" })
	public void FPTC_1265_SitePortalValidationOfDuplicateScreeningField() {
		...
		reportLog("1.6: Verify Existence of Subject #1");
		...
		subjectDetailPage.verifySubjectDetailAndScreeningIsDisplayed(Subject02);
		...
		reportLog("3.1: Update Screening no in Edit subject modal window");
		subjectDetailPage.clearScreeningInp();
		subjectDetailPage.inputScreeningNumber(Subject01);
