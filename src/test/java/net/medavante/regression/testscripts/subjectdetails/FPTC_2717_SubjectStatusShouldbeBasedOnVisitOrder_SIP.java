...
public class FPTC_2717_SubjectStatusShouldbeBasedOnVisitOrder_SIP extends BaseTest {

	@Factory(dataProvider = "Browsers", dataProviderClass = DataProviders.class)
	public FPTC_2717_SubjectStatusShouldbeBasedOnVisitOrder_SIP(String browser) {
		super(browser);
	}
	...
	/**
	 * ====================================================================================================================
	 * Test Case Id: FP-TC-2717 Test Case Name:Site portal: Subject status
	 * should be based on visit order. The last Unscheduled visit with
	...
	public void FPTC_2717_verifySubjectStatusShouldbeBasedOnVisitOrder() {
