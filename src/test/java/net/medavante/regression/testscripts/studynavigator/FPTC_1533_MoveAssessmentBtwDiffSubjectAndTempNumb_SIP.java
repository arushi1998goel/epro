...
public class FPTC_1533_MoveAssessmentBtwDiffSubjectAndTempNumb_SIP extends BaseTest {
	...
	public FPTC_1533_MoveAssessmentBtwDiffSubjectAndTempNumb_SIP(String browser) {
		super(browser);
	}
	...
	public void getTestData() throws Exception {
		...
		reportLog("At least 1 completed Non-CR Assessments for Subject 1: with Screening# number and TempID: ‘Empty’ has no value exists");
		
		dashBoardPage = loginPage.loginInApplication(SuperAdminUN, SuperAdminPW);
		studyNavigatorDashBoardPage = dashBoardPage.selectHorizontalUpperNavMenuItem(StudyDashBoardPage.class, Constants.NavigateText, Constants.StudyText);

		studyNavigatorDashBoardPage.creatingSubjectForPreRequisite(studyName, Constants.ATAssignedRater_10,screeningNum1);
		...
		reportLog("At least 1 not completed and not assigned Non-CR Assessments for Subject 2: Screening# ‘Empty’ has no value and with TempID number exists");
		...
		reportLog("At least 1 completed Non-CR Assessments for Subject 3: Screening# ‘Empty’ has no value and with TempID number exists");
		subjectDetailPage.selectHorizontalUpperNavMenuItem(StudyDashBoardPage.class, Constants.NavigateText, Constants.StudyText);
		...
		reportLog("At least 1 not completed and not assigned Non-CR Assessments for Subject 4: with Screening# number  and TempID: ‘Empty’ has no value exists");
		subjectDetailPage.selectHorizontalUpperNavMenuItem(StudyDashBoardPage.class, Constants.NavigateText, Constants.StudyText);
		...
		assessmentDetailPage = studyNavigatorDashBoardPage.selectByVisitAndSubjectName(completedNonCRVisit, screeningNum1);
	...
	/**
	 * ====================================================================================================================
	 * Test Case Id: FP-TC-1533 Test Case Name: Verify that Subject's TempID reflected change in PDF Source Audit History in case when Assessment was moved
	 * ====================================================================================================================
	 * 
	 * @throws InterruptedException
	 */

	@Test(description = "FP-TC-1533_Verify that Subject's TempID reflected change in PDF Source Audit History in case when Assessment was moved", groups = {})
	public void FPTC_1533_MoveAssessmentBetweenDifferentSubjectScreeningAndTemporaryIDNumbers() throws InterruptedException {
		...
		reportLog("Click on Assessment link");
		studyNavigatorDashBoardPage.searchSubject(screeningNum1);
		...
		reportLog("2.2.1: Screening Number with OLD value and New Value ‘Empty and Change Reason “Assessment Transfer”");
		assessmentDetailPage.verifyInformationIsPresentInAuditHistory(screeningNum1);
		
		reportLog("2.2.2: TemporaryID with OLD value ‘Empty’ and New Value and Change Reason “Assessment Transfer”.");
...
//		subjectDetailPage.setStartedDate();
		...
		reportLog("4.2.1: Screening Number with OLD value and New Value ‘Empty and Change Reason “Assessment Transfer”");
		assessmentDetailPage.verifyInformationIsPresentInAuditHistory(screeningNum4);
		
		reportLog("4.2.2: TemporaryID with OLD value ‘Empty’ and New Value and Change Reason “Assessment Transfer”.");
