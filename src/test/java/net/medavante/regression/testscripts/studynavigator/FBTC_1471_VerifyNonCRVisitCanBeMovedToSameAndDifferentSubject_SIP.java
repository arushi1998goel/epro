...
public class FBTC_1471_VerifyNonCRVisitCanBeMovedToSameAndDifferentSubject_SIP extends BaseTest {
	...
	public FBTC_1471_VerifyNonCRVisitCanBeMovedToSameAndDifferentSubject_SIP(String browser) {
		super(browser);
	}
	...
	public void getTestData() throws Exception {
		...
		studyNavigatorDashBoardPage.creatingSubjectForPreRequisite(studyName, Constants.ATAssignedRater_11,
				subjectName1);
		...
		studyNavigatorDashBoardPage = dashBoardPage.selectHorizontalUpperNavMenuItem(StudyDashBoardPage.class,
				Constants.NavigateText, Constants.StudyText);
		studyNavigatorDashBoardPage.selectStudy(studyName, Constants.ATAssignedRater_11);
	...
	/**
	 * ====================================================================================================================
	 * Test Case Id: FB-TC-1471 Test Case Name: Verify that Non-CR Visit can be
	...
	@Test(description = "FB-TC-1471_Verify that Non-CR Visit can be moved to the same and different Subject.", groups = {})
	public void FBTC_1471_VerifyNonCRVisitCanBeMovedToSameAndDifferentSubject() throws InterruptedException {
		...
		reportLog("2.5: Select an action to Save the changes (Control 'Save')");
		visitDetaiLPage. clickOnSaveButtonOnChangeAssesment();
		
		reportLog("2.6: Select an action to Confirm the changes (Control 'Confirm')");
		visitDetaiLPage. clickOnConfirmButtonOfChangeAssesment();


		reportLog("2.7: Select reason for change");
		...
		reportLog("3.4: Select an action to Save the changes (Control 'Save')");
		visitDetaiLPage. clickOnSaveButtonOnChangeAssesment();
		
		reportLog("3.5: Select an action to Confirm the changes (Control 'Confirm')");
		visitDetaiLPage. clickOnConfirmButtonOfChangeAssesment();

		reportLog("3.6: Save changes");
		visitDetaiLPage.verifyReasonForChangePopUpDisplayed();
		visitDetaiLPage.selectReasonForChangeOption(Constants.Other_Reason_For_Change);
		visitDetaiLPage.inputReasonComment(Constants.Other_Reason_For_Change);
		visitDetaiLPage.eSignForReasonForChange(SuperAdminUN, SuperAdminPW);
