...
public class FPTC_1487_NonCRAssNotAdminiQualifiedPerson_MAP
		extends BaseTest {

	private String visitName, subjectName = "AutoSubject2206" + generateRandomAlphanumericString(5);

	@Factory(dataProvider = "Browsers", dataProviderClass = DataProviders.class)
	public FPTC_1487_NonCRAssNotAdminiQualifiedPerson_MAP(
			String browser) {
		super(browser);
	}
	...
	/**
	 * =============================================================================================================================================
	 * Test Case Id: FP-TC-1487 Test Case Name:Non-CR ClinRO assessment as 'Not
	 ...
	 * 
	 */
	@Test(description = "FP-TC-1487_NonCRClinROAssessmentAsNotAdministeredForQualifiedPersonAndAPersonWhoIsAssignedFromAssessmentDetailsPage", groups = {})
	public void FPTC_1487_VerifyNonCRAssNotAdminiQualifiedPerson()
			throws InterruptedException {
		...
		reportLog("7.3: Not administered and submitted assessment is displayed with 'Not administered' form thumbnail. ");
		subjectDetailPage.clickOnVisitRow(visitName);
