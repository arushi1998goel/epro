...
public class FPTC_1513_ComplClinROEditStartDateTimeDuration_SIP extends BaseTest {
	...
	public FPTC_1513_ComplClinROEditStartDateTimeDuration_SIP(String browser) {
		super(browser);
	}
	...
	public void getTestData() throws Exception {
		...
		visit = properties.getProperty("Auto_Visit_ClinROForms");
		...
		subjectDetailPage.clickOnVisitRow(visit);
		...
		assessmentDetailPage = studyNavigatorDashBoardPage.selectByAssesmentNameAndVisitAndSubjectName(Constants.Assesment_AdasCog14List1FormName, visit, subjectName);
	...
	/**
	 * ====================================================================================================================
	 * Test Case Id: FP-TC-1513 || Test Case Name: Completed 'ClinRo' Assessment - Edit Start Date, Time and Duration 
	 * ====================================================================================================================
	 * 
	 * @throws ParseException
	 */

	@Test(description = "FP-TC-1513_Completed 'ClinRo' Assessment - Edit Start Date, Time and Duration ", groups = {})
	public void FPTC_1513_ComplClinROEditStartDateTimeDuration() throws ParseException {
		...
		assessmentDetailPage = studyNavigatorDashBoardPage
				.selectByAssesmentNameAndVisitAndSubjectName(Constants.Assesment_AdasCog14List1FormName, visit, subjectName);

		reportLog("2.4: Verify assessment Details Page is opened");
		assessmentDetailPage.verifyAssessmentDetailsDisplayed();

		reportLog("3: Verify edit control is displayed and enabled");
		...
		assessmentDetailPage.verifyAssessmentDateIsPresentInFooterOnEachPageOfPDF(startedUpdatedDateTime);
