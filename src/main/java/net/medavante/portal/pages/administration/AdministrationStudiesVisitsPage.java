...
public class AdministrationStudiesVisitsPage extends BasePage {
	...
	@FindBy(xpath="//div[@class='btn ng-binding btn-default' and @disabled='disabled']")
	private WebElement mappingDisableControl;
	
	@FindBy(xpath="//div[@class='col-xs-15']//span//a[@disabled='disabled']")
	private WebElement searchFieldForVisits;
	
	@FindBy(xpath="//div[@class='col-xs-15']//span//a[@disabled='disabled']")
	private WebElement visitsDisableTab;
	...
	/***
	 * Verify visits tab is in view mode
	 */

	
	public void verifyVisitsTabIsInViewMode() {

		moveToElement(visitsDisableTab);
		String value=visitsDisableTab.getAttribute("disabled");
 ...
 */
	...
	public void searchFieldIsAvailable() {
		...
		moveToElement(searchFieldForVisits);
		if(searchFieldForVisits.isDisplayed()) {
			Assert.assertTrue(true);
		}
	...
	/***]
	 * Mapping control is disabled
	 */
	
	public void mappingControlIsDisabled() {

		moveToElement(mappingDisableControl);
		String value=mappingDisableControl.getAttribute("disabled");
		if(value.contains("disabled")) {
			Assert.assertTrue(true);
		}
